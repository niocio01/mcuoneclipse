		...
		uint8_t					expected_value)
{
	...
	do
	{
		...
		value = p_dev->temp_buffer[pos] & mask;
	}
		...
		uint8_t				*p_is_alive)
{
	...
	// VL53L5CX_WaitMs(&(p_dev->platform), 1);
		...
		VL53L5CX_Configuration		*p_dev)
{
	...
	status |= VL53L5CX_WrMulti(&(p_dev->platform), 0x2fd8, (uint8_t*)VL53L5CX_GET_NVM_CMD, sizeof(VL53L5CX_GET_NVM_CMD));
	...
	status |= VL53L5CX_WrMulti(&(p_dev->platform), 0x2c34, p_dev->default_configuration, sizeof(VL53L5CX_DEFAULT_CONFIGURATION));
